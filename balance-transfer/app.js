...
app.post('/channels', async function(req, res) {
	...
	let message = createChannel.createChannel(channelName, channelConfigPath, req.username, req.orgname);
	res.send(message);
});
// Join Channel
...
app.post('/chaincodes', async function(req, res) {
	...
	let message = await install.installChaincode(peers, chaincodeName, chaincodePath, chaincodeVersion, req.username, req.orgname);
	res.send(message);
});
...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	let message = await instantiate.instantiateChaincode(channelName, chaincodeName, chaincodeVersion, fcn, args, req.username, req.orgname);
	res.send(message);
});
...
app.get('/channels/:channelName/blocks', async function(req, res) {
	...
	let message = query.getBlockByHash(peer, req.params.channelName, hash, req.username, req.orgname);
	res.send(message);
});
