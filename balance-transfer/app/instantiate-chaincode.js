...
var instantiateChaincode = async function(channelName, chaincodeName, chaincodeVersion, functionName, args, username, org_name) {
	...
	try {
		...
		let results = await channel.sendInstantiateProposal(request);
