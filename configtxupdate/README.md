...
It is recommended to run the example by invoking the script `fabric-samples/configtxupdate/bootstrap_batchsize/script.sh` as follows:
...
The recommended path to proceed with this example is to run the script located at `fabric-samples/configtxupdate/reconfigure_batchsize/script.sh` by invoking
...
To see this example run the script `fabric-samples/configtxupdate/reconfig_membership/script.sh` by:
