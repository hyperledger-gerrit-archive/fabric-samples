...
curl https://nexus.hyperledger.org/content/repositories/releases/org/hyperledger/fabric/hyperledger-fabric/$MARCH-amd64-$VERSION/hyperledger-fabric-$MARCH-amd64-$VERSION.tar.gz | tar xz
if [ $? -ne 0 ]; then
