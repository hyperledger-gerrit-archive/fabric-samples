...
curl https://nexus.hyperledger.org/content/repositories/releases/org/hyperledger/fabric/hyperledger-fabric/$MARCH-${OS_VER}-$VERSION/hyperledger-fabric-$MARCH-${OS_VER}-$VERSION.tar.gz | tar xz
if [ $? -ne 0 ]; then
