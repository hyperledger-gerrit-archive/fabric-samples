...
public class Config {
	...
	private Config() {
		...
		try {
			 ...
			 */
			sdkProperties.load(new FileInputStream("src/main/resources/config.properties"));
			...
			for (Map.Entry<String, Org> org : sampleOrgs.entrySet()) {
				...
				if (true) {
					String cert = "src/main/java/blockchain/config/e2e-Orgs/channel/crypto-config/peerOrganizations/DNAME/ca/ca.DNAME-cert.pem"
	...
	public String getChannelPath() {
		...
		return PATH+"/src/main/java/blockchain/config/e2e-Orgs/channel";
