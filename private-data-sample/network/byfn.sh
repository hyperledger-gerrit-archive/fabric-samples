...
docker-compose -f $COMPOSE_FILE -f $COMPOSE_FILE_COUCH  down --volumes --remove-orphans
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    # Cleanup the fabric-ca keys generated for dyanmically registered users
    echo "Removing ../api/fabric-client-kv-org folders"
...
echo "COMPOSE_FILE used are ${COMPOSE_FILE}"
echo "IMAGETAG used is ${IMAGETAG}"
