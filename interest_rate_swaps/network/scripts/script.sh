...
instantiateChaincode() {
	...
	peer chaincode instantiate -o irs-orderer:7050 -C irs -n irscc -l golang -v 0 -c '{"Args":["init","auditor","100000","rrprovider","libor"]}' -P "AND(OR('partya.peer','partyb.peer','partyc.peer'), 'auditor.peer')"
...
setReferenceRate() {
	...
	peer chaincode invoke -o irs-orderer:7050 -C irs --waitForEvent -n irscc --peerAddresses irs-rrprovider:7051 -c '{"Args":["setReferenceRate","libor","3"]}'
...
createSwap() {
	...
	echo "===================== Invoking chaincode ===================== "
	peer chaincode invoke -o irs-orderer:7050 -C irs --waitForEvent -n irscc --peerAddresses irs-partya:7051 --peerAddresses irs-partyb:7051 --peerAddresses irs-auditor:7051 -c '{"Args":["createSwap","myswap","{\"StartDate\":\"2018-09-27\",\"EndDate\":\"2018-09-30\",\"PaymentInterval\":395,\"PrincipalAmount\":10,\"FixedRate\":4,\"FloatingRate\":5,\"ReferenceRate\":\"libor\"}", "partya", "partyb"]}'
	echo "===================== Chaincode invoked ===================== "
}
...
echo "Setting libor reference rate"
sleep 3
setReferenceRate
