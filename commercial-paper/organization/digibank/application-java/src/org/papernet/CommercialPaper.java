...
public class CommercialPaper extends State {
    ...
    public CommercialPaper setKey() {
        this.key = State.makeKey(new String[] { this.paperId });
        return this;
    }
    ...
    public CommercialPaper setPaperId(String paperId) {
    ...
    public String toString() {
        return "Paper::" + this.key + "   " + this.getPaperId() + " " + getIssuer() + " " + getFaceValue();
    }
    ...
    public static CommercialPaper deserialize(byte[] data) {
        ...
        return createInstance(issuer, paperNumber, issueDateTime, maturityDateTime, faceValue);
    }
    ...
    public static CommercialPaper createInstance(String issuer, String paperNumber, String issueDateTime,
        ...
        return new CommercialPaper().setIssuer(issuer).setPaperId(paperNumber).setMaturityDateTime(maturityDateTime)
                .setFaceValue(faceValue).setKey();
    }
