...
async function main() {
    try {
        ...
        // Get the channel event hub object
        const channel_event_hub = channel.getChannelEventHub(peer_name);
        ...
        const block_reg = channel_event_hub.registerBlockEvent(
            async (block) => {
                ...
                // Add an entry to the ProcessingMap for each block received
        ...
        // connect to the channel event hub and begin listening
