...
function removeOrgIdentities () {
  ...
  path_cli_configtx=$ORG_PATH"/"$org"/configuration/cli/configtx"
  path_orderer_configtx=$ORG_PATH"/"$org"/configuration/orderer/configtx"
  ...
  rm -r $path_cli_configtx || true
  rm -r $path_orderer_configtx || true
