...
function generateIdentities () {
  ...
  rm -r $orgSource"/ordererOrganizations" || true
...
function copyIdentities () {
  ...
  echo Copying identity information for $fqorg
  ...
  echo Copying Organization information $fqorg
...
org="digibank"
orgDNS="orderer."$org".example.com"

generateIdentities $org

copyIdentities $org $orgDNS 1