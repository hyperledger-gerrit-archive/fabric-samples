...
# Wait for the intermediate CA chain file to be created
...
fabric-ca-client enroll --enrollment.profile tls -u https://$ORDERER_NAME_PASS@$INT_CA_HOST:7054 \
...
# Get orderer's ECert
fabric-ca-client enroll -u https://$ORDERER_NAME_PASS@$INT_CA_HOST:7054 -M $ORDERER_GENERAL_LOCALMSPDIR
...
export ORDERER_DEBUG_BROADCASTTRACEDIR=/share/logs
orderer
