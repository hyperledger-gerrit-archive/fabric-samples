...
function printHelp () {
  echo "Usage: "
  echo "  byfn.sh -m up|down|restart|generate [-c <channel name>] [-t <timeout>] [-d <dbtype>]"
  ...
  echo "    -d <dbtype> - the database backend to use: goleveldb (default) or couchdb"
  echo
  echo
  ...
  echo "	byfn.sh -m up -c mychannel -d couchdb"
