...
function printHelp () {
  echo "Usage: "
  echo "  eyfn.sh up|down|restart|generate [-c <channel name>] [-t <timeout>] [-d <delay>] [-f <docker-compose-file>] [-s <dbtype>] [-a]"
...
function networkDown () {
  docker-compose -f $COMPOSE_FILE_ORG3.yaml down
  docker-compose -f $COMPOSE_FILE_ORG3.yaml -f $COMPOSE_FILE_COUCH_ORG3.yaml down
