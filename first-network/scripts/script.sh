...
queryStatus 1 0 1 "Org1MSP: approved" "Org2MSP: not approved"
queryStatus 1 0 2 "Org1MSP: approved" "Org2MSP: not approved"

## now approve also for org2
approveForMyOrg 1 0 2

## query the approval status on both orgs, expect them both to have approved
queryStatus 1 0 1 "Org1MSP: approved" "Org2MSP: approved"
queryStatus 1 0 2 "Org1MSP: approved" "Org2MSP: approved"
