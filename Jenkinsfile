      ...
      stage("Run byfn_eyfn Tests") {
         wrap([$class: 'AnsiColorBuildWrapper', 'colorMapName': 'xterm']) {
           ...
           if (currentBuild.result == 'FAILURE') { // Other values: SUCCESS, UNSTABLE
               rocketSend channel: 'jenkins-robot', message: "Build Notification - BUILD_STATUS: ${currentBuild.result} Branch: ${env.GERRIT_BRANCH} - Project: ${env.PROJECT} - (<${env.BUILD_URL}|Open>)"
           }
        }
// try end here
  }
