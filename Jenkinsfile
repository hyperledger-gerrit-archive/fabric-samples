          ...
          steps {
            script {
                if(props["SKIP_PULL_IMAGES"] == "true") {
                  ...
                  sh 'cp -r $ROOTDIR/gopath/src/github.com/hyperledger/fabric/release/$ARCH-$MARCH/bin $ROOTDIR/$BASE_DIR/fabric-samples/'
                  fabBuildLibrary.pullDockerImages(props["FAB_BASE_VERSION"], 'nodenv')
